...
import com.paymentchain.billing.common.InvoiceRequestMapperImpl__BeanDefinitions;
import com.paymentchain.billing.common.InvoiceResponseMapperImpl__BeanDefinitions;
import com.paymentchain.billing.common.SecurityConfiguration__BeanDefinitions;
import com.paymentchain.billing.controller.InvoiceRestController__BeanDefinitions;
import com.paymentchain.billing.exception.ApiExceptionHandler__BeanDefinitions;
import com.paymentchain.billing.respository.InvoiceRepository__BeanDefinitions;
 ...
 */
public class InvoiceApplication__BeanFactoryRegistrations {
  /**
  ...
  public void registerBeanDefinitions(DefaultListableBeanFactory beanFactory) {
    ...
    beanFactory.registerBeanDefinition("invoiceApplication", InvoiceApplication__BeanDefinitions.getInvoiceApplicationBeanDefinition());
    beanFactory.registerBeanDefinition("invoiceRequestMapperImpl", InvoiceRequestMapperImpl__BeanDefinitions.getInvoiceRequestMapperImplBeanDefinition());
    beanFactory.registerBeanDefinition("invoiceResponseMapperImpl", InvoiceResponseMapperImpl__BeanDefinitions.getInvoiceResponseMapperImplBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("invoiceRestController", InvoiceRestController__BeanDefinitions.getInvoiceRestControllerBeanDefinition());
    beanFactory.registerBeanDefinition("apiExceptionHandler", ApiExceptionHandler__BeanDefinitions.getApiExceptionHandlerBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("users", SecurityConfiguration__BeanDefinitions.getUsersBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("org.springdoc.core.configuration.SpringDocConfiguration$OpenApiResourceAdvice", SpringDocConfiguration__BeanDefinitions.OpenApiResourceAdvice__BeanDefinitions.getOpenApiResourceAdviceBeanDefinition());
    beanFactory.registerBeanDefinition("org.springdoc.core.configuration.SpringDocConfiguration$SpringDocSpringDataWebPropertiesProvider", SpringDocConfiguration__BeanDefinitions.SpringDocSpringDataWebPropertiesProvider__BeanDefinitions.getSpringDocSpringDataWebPropertiesProviderBeanDefinition());
    beanFactory.registerBeanDefinition("springDataWebPropertiesProvider", SpringDocConfiguration__BeanDefinitions.SpringDocSpringDataWebPropertiesProvider__BeanDefinitions.getSpringDataWebPropertiesProviderBeanDefinition());
    beanFactory.registerBeanDefinition("org.springdoc.core.configuration.SpringDocConfiguration$WebConversionServiceConfiguration", SpringDocConfiguration__BeanDefinitions.WebConversionServiceConfiguration__BeanDefinitions.getWebConversionServiceConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("webConversionServiceProvider", SpringDocConfiguration__BeanDefinitions.WebConversionServiceConfiguration__BeanDefinitions.getWebConversionServiceProviderBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("org.springdoc.core.configuration.SpringDocSecurityConfiguration$SpringSecurityLoginEndpointConfiguration", SpringDocSecurityConfiguration__BeanDefinitions.SpringSecurityLoginEndpointConfiguration__BeanDefinitions.getSpringSecurityLoginEndpointConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("springSecurityLoginEndpointCustomiser", SpringDocSecurityConfiguration__BeanDefinitions.SpringSecurityLoginEndpointConfiguration__BeanDefinitions.getSpringSecurityLoginEndpointCustomiserBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("org.springdoc.webmvc.core.configuration.SpringDocWebMvcConfiguration$SpringDocWebMvcRouterConfiguration", SpringDocWebMvcConfiguration__BeanDefinitions.SpringDocWebMvcRouterConfiguration__BeanDefinitions.getSpringDocWebMvcRouterConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("routerFunctionProvider", SpringDocWebMvcConfiguration__BeanDefinitions.SpringDocWebMvcRouterConfiguration__BeanDefinitions.getRouterFunctionProviderBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("jpa.InvoiceRepository.fragments#0", RepositoryComposition__BeanDefinitions.RepositoryFragments__BeanDefinitions.getFragmentsBeanDefinition());
    beanFactory.registerBeanDefinition("invoiceRepository", InvoiceRepository__BeanDefinitions.getInvoiceRepositoryBeanDefinition());
